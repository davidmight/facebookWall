...
void IBE_Encryptor :: extract(ECn& A,ZZn& x,ZZn& y)
{ 
    x=(A.get_point())->X;
    y=(A.get_point())->Y;
}

void IBE_Encryptor :: extract(ECn& A,ZZn& x,ZZn& y,ZZn& z)
{ 
    big t;
    x=(A.get_point())->X;
    y=(A.get_point())->Y;
...
ZZn2 IBE_Encryptor :: line(ECn& A,ECn& C,ZZn& slope,ZZn2& Qx,ZZn2& Qy)
{ 
    ZZn2 n=Qx,w=Qy;
    ZZn x,y,z,t;
#ifdef AFFINE
...
ZZn2 IBE_Encryptor :: vertical(ECn& A,ZZn2& Qx)
{
    ZZn2 n=Qx;
    ZZn x,y,z;
#ifdef AFFINE
...
void IBE_Encryptor :: g(ECn& A,ECn& B,ZZn2& Qx,ZZn2& Qy,ZZn2& num)
{
    ZZn  lam,mQy;
    ZZn2 d,u;
    big ptr;
...
BOOL IBE_Encryptor :: fast_tate_pairing(ECn& P,ZZn2& Qx,ZZn2& Qy,Big& q,ZZn2& res)
{ 
    int i,nb;
    Big n,p;
    ECn A;
...
BOOL IBE_Encryptor :: ecap(ECn& P,ECn& Q,Big& order,ZZn2& cube,ZZn2& res)
{
     ZZn2 Qx,Qy;
     Big xx,yy;
#ifdef SCOTT
...
Big IBE_Encryptor :: H1(char *string)
...
Big IBE_Encryptor :: H3(char *x1,char *x2)
{
    sha256 sh;
    char h[HASH_LEN];
    Big a;
...
ECn IBE_Encryptor :: map_to_point(char *ID)
{
    ECn Q;
    Big x0,y0=H1(ID);
...
void IBE_Encryptor :: strip(char *name)
...
void IBE_Encryptor :: encrypt(char *result, char *recipient, char *input)
{
